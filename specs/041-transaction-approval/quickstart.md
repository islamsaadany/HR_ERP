...
```bash
psql -f prisma/sql/069_payment_batches.sql hrerp_test
psql -f prisma/sql/069_payment_batches.sql hrerp_test   # again: must be a clean no-op
```
...
-- the reserved columns from 040 must be gone
