...
Only the questions the existing codebase does not already answer. Spec 040 settled money handling,
...
**Rationale**: Spec 040 wrote the enum in an order that leaves room for this and said so in the
