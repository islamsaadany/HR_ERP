...
- **No clarification markers**: the eight decisions that would otherwise have been marked were put
  ...
  lines and Finance reviews; payback routed Finance-then-CEO (the CEO half is spec 040); per-period
  budget only, Forecast and Tools Subscription out; two specs (039 here, 040 approval + payroll);
