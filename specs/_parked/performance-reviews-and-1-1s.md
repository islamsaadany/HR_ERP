...
> **Status: specced 2026-08-24 as [`specs/042-performance-reviews-1-1s`](../042-performance-reviews-1-1s/spec.md).
> Still not built.** This file is no longer a parking space; it is the **agreed input** behind spec 042
