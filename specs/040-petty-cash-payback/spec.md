...
**Out of scope, deliberately** (spec 041): the CEO's final transaction approval and the email that
...
- **The CEO's bank confirmation is spec 041** and is layered on top of the payment records this
