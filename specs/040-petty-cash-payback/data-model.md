...
`prisma/sql/068_petty_cash_payback.sql` in the same commit.
...
| `paymentRunId` | `String?` | **reserved for spec 041** — no relation, do not repurpose |
| `createdAt` | `DateTime` | |
...
| `paymentRunId` | `String?` | **reserved for spec 041** |
...
## Migration notes (`prisma/sql/068_petty_cash_payback.sql`)
