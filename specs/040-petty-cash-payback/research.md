...
## R8 — What must be shaped now for spec 041, without building it?
...
approval state machine) would be building 041 inside 040, which the CEO explicitly scoped apart.
