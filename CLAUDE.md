...
**v1 modules:** Foundation (auth + roles + employee registry + **My Documents** personal uploads) · Onboarding · Benefits · Team Directory · **Handbook & Resources** (shared policies/handbook + downloadable company files) · Time-Off / Leave Management · Dashboard · Learning Track (placeholder in v1) · **Team Communications** (announcements + birthday/anniversary congratulations, spec 039) · **Finance** (petty cash floats + payback requests, spec 040; bank confirmations + monthly salary runs, spec 041).
