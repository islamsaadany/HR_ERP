-- HR_ERP — Finance: bank confirmations & monthly salary runs (spec 041, 2026-08-24).
--
-- WHY
...
--
-- THE ENUM CHANGE
--   `PaybackStatus` gains PAYMENT_SUBMITTED, the position spec 040 reserved in the schema
...
-- ─── Drop the columns spec 040 reserved but this design did not use ────────
--
