...
export async function createEmployee(
  ...
  await prisma.user.create({
    data: {
      ...
      legalNameAr: data.legalNameAr ?? null,
...
const FIELD_SCHEMAS = {
  ...
  legalName: employeeSchema.shape.legalName,
  legalNameAr: employeeSchema.shape.legalNameAr,
  nationalId: employeeSchema.shape.nationalId,
