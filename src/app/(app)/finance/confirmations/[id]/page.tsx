...
import { markComplete, returnToFinance } from "@/app/(app)/finance/confirmations/actions";
 ...
 *
 * Lives under /finance since 2026-09-08, when the confirmer's list became a tab on Payments; the
 * guard is unchanged (appointed, or a Super User), and the way back is that tab.
 */
