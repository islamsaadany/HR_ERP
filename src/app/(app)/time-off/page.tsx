    ...
    <div className="max-w-3xl">
      ...
      <section className="mt-6 rounded-xl border border-line bg-surface p-6">
        ...
        <form action={createLeaveRequest} className="grid gap-4 sm:grid-cols-2">
          <div>
            <label htmlFor={"timeoff-startDate"} className="block text-xs uppercase tracking-wide text-muted mb-1">Start date</label>
            <input id={"timeoff-startDate"} name="startDate" type="date" min={today} required className="w-full rounded-lg border border-line px-3 py-2 text-sm" />
          </div>
          <div>
            <label htmlFor={"timeoff-endDate"} className="block text-xs uppercase tracking-wide text-muted mb-1">End date</label>
            <input id={"timeoff-endDate"} name="endDate" type="date" min={today} required className="w-full rounded-lg border border-line px-3 py-2 text-sm" />
          </div>
          <div className="sm:col-span-2">
            <label htmlFor={"timeoff-note"} className="block text-xs uppercase tracking-wide text-muted mb-1">Note (optional)</label>
